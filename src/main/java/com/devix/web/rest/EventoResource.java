...
import com.devix.service.EventoQueryService;
import com.devix.service.EventoService;
...
/**
 * REST controller for managing {@link com.devix.domain.Evento}.
 */
@RestController
...
public class EventoResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<EventoDTO>> getAllEventos(EventoCriteria criteria) {
        LOG.debug("REST request to get Eventos by criteria: {}", criteria);

        List<EventoDTO> entityList = eventoQueryService.findByCriteria(criteria);
