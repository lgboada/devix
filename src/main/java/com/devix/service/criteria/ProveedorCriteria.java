...
/**
 * Criteria class for the {@link com.devix.domain.Proveedor} entity. This class is used
 * in {@link com.devix.web.rest.ProveedorResource} to receive all the possible filtering options from
...
public class ProveedorCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, noCia, dni, nombre, contacto, email, pathImagen, telefono, productosId, distinct);
    }
