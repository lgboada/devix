...
import { sampleWithRequiredData } from '../tipo-direccion.test-samples';
...
describe('TipoDireccion Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [TipoDireccionComponent],
      providers: [
        provideHttpClient(),
        {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.tipoDireccions()[0]).toEqual(expect.objectContaining({ id: 22481 }));
  });

  describe('trackId', () => {
    it('should forward to tipoDireccionService', () => {
      const entity = { id: 22481 };
      jest.spyOn(service, 'getTipoDireccionIdentifier');
      const id = comp.trackId(entity);
      expect(service.getTipoDireccionIdentifier).toHaveBeenCalledWith(entity);
