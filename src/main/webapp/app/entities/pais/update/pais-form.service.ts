...
type PaisFormGroupContent = {
  ...
  noCia: FormControl<IPais['noCia']>;
  descripcion: FormControl<IPais['descripcion']>;
};
...
export class PaisFormService {
  createPaisFormGroup(pais: PaisFormGroupInput = { id: null }): PaisFormGroup {
    ...
    return new FormGroup<PaisFormGroupContent>({
      ...
      noCia: new FormControl(paisRawValue.noCia, {
        validators: [Validators.required],
      }),
      descripcion: new FormControl(paisRawValue.descripcion, {
        validators: [Validators.required],
      }),
    });
  }
