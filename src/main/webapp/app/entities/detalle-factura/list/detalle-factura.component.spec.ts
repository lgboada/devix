...
import { sampleWithRequiredData } from '../detalle-factura.test-samples';
...
describe('DetalleFactura Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.detalleFacturas()[0]).toEqual(expect.objectContaining({ id: 26550 }));
  });

  describe('trackId', () => {
    it('should forward to detalleFacturaService', () => {
      const entity = { id: 26550 };
