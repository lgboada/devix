...
import { sampleWithRequiredData } from '../tipo-evento.test-samples';
...
describe('TipoEvento Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.tipoEventos()[0]).toEqual(expect.objectContaining({ id: 26103 }));
  });

  describe('trackId', () => {
    it('should forward to tipoEventoService', () => {
      const entity = { id: 26103 };
      jest.spyOn(service, 'getTipoEventoIdentifier');
      const id = comp.trackId(entity);
      expect(service.getTipoEventoIdentifier).toHaveBeenCalledWith(entity);
